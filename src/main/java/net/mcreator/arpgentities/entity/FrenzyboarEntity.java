...
public class FrenzyboarEntity extends ArpgEntitiesModElements.ModElement {
	public static EntityType entity = null;
	public FrenzyboarEntity(ArpgEntitiesModElements instance) {
		super(instance, 1);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.9f, 0.9f)).build("frenzyboar")
						.setRegistryName("frenzyboar");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16724788, -6710887, new Item.Properties().group(SCOMobsItemGroup.tab))
				.setRegistryName("frenzyboar_spawn_egg"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.getSpawns(EntityClassification.CREATURE).add(new Biome.SpawnListEntry(entity, 26, 4, 4));
		}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new PigModel(), 0.5f) {
			...
			public ResourceLocation getEntityTexture(Entity entity) {
				return new ResourceLocation("arpg_entities:textures/pig.png");
			}
		});
	}
	public static class CustomEntity extends PigEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("Frenzy Boar"));
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Frenzyboar");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new TestGuiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
