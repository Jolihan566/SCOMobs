...
package net.mcreator.arpgentities.entity;
...
public class KleinEntity extends ArpgEntitiesModElements.ModElement {
	public static EntityType entity = null;
	public KleinEntity(ArpgEntitiesModElements instance) {
		super(instance, 7);
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -52480, -13312, new Item.Properties().group(SCOMobsItemGroup.tab)).setRegistryName("klein_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelfixedsteve(), 0.5f) {
				{
					this.addLayer(new GlowingLayer<>(this));
				}
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("arpg_entities:textures/klein2.png");
				}
			};
		});
	}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn.getBuffer(RenderType.getEyes(new ResourceLocation("arpg_entities:textures/klein2.png")));
	...
	public static class Modelfixedsteve extends EntityModel<Entity> {
